...
bot = telegram.Bot(token='7114623003:AAG0He32-2cLTSv52vjXiXss_FeUj3XRLhU') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='7114623003:AAG0He32-2cLTSv52vjXiXss_FeUj3XRLhU', use_context=True) #Replace TOKEN with your token string
